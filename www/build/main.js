...
var PrivacyPolicyPage = (function () {
    ...
    PrivacyPolicyPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-privacy-policy',template:/*ion-inline-start:"D:\sale\src\pages\privacy-policy\privacy-policy.html"*/'<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-buttons left>\n\n      <button ion-button icon-only (click)="dismiss()">\n\n        <ion-icon name="close"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>{{\'Privacy Policy\'|translate}}</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div [innerHTML]="sharedData.privacyPolicy"></div>\n\n</ion-content>'/*ion-inline-end:"D:\sale\src\pages\privacy-policy\privacy-policy.html"*/,
        }),
...
var TermServicesPage = (function () {
    ...
    TermServicesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-term-services',template:/*ion-inline-start:"D:\sale\src\pages\term-services\term-services.html"*/'\n\n<ion-header>\n\n  \n\n    <ion-navbar>\n\n      <ion-buttons left>\n\n        <button ion-button icon-only (click)="dismiss()">\n\n              <ion-icon name="close"></ion-icon>\n\n            </button>\n\n      </ion-buttons>\n\n      <ion-title translate> {{\'Term and Services\'| translate }}</ion-title>\n\n    </ion-navbar>\n\n  \n\n  </ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <div [innerHTML]="sharedData.termServices"></div>\n\n</ion-content>\n\n\n\n'/*ion-inline-end:"D:\sale\src\pages\term-services\term-services.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["C" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_3__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
...
var RefundPolicyPage = (function () {
    ...
    RefundPolicyPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-refund-policy',template:/*ion-inline-start:"D:\sale\src\pages\refund-policy\refund-policy.html"*/'<ion-header>\n\n  \n\n    <ion-navbar>\n\n      <ion-buttons left>\n\n        <button ion-button icon-only (click)="dismiss()">\n\n          <ion-icon name="close"></ion-icon>\n\n        </button>\n\n      </ion-buttons>\n\n      <ion-title>{{\'Refund Policy\'|translate}}</ion-title>\n\n    </ion-navbar>\n\n  \n\n  </ion-header>\n\n  \n\n  \n\n  <ion-content padding>\n\n    <div [innerHTML]="sharedData.refundPolicy"></div>\n\n  </ion-content>'/*ion-inline-end:"D:\sale\src\pages\refund-policy\refund-policy.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["C" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
            __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */]])
...
var SubCategoriesPage = (function () {
    ...
    SubCategoriesPage = SubCategoriesPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\sub-categories\sub-categories.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>\n      {{\'Sub Categories\'| translate }}\n    </ion-title>\n\n    <ion-buttons end>\n      <button ion-button icon-only (click)="openSearch()">\n        <ion-icon name="search"></ion-icon>\n      </button>\n      <button ion-button icon-only class="cart-button" (click)="openCart()">\n        <ion-icon name="cart">\n          <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n        </ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n<ion-content text-center>\n  <ion-grid>\n    <ion-row>\n      <ion-col col-6 *ngFor="let c of subcategories" (click)="openProducts(c.id)" class="animated flipInX">\n      	\n          <ion-card >\n          	<div class="category-icon"><img *ngIf="c.image" src="{{c.image.src}}" /></div>\n            <div class="cateogry-content">\n                <div class="categories-title">{{c.name}}</div>\n                <div class="categories-subtitle">{{c.count}} {{\'Products\'| translate }} </div>\n            </div>\n\n          </ion-card>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  <button ion-button icon-end color="secondary" (click)="openParentProducts()">{{ \'View All\' | translate }}\n    <ion-icon name="ios-arrow-dropright-circle-outline"></ion-icon>\n</button>\n</ion-content>'/*ion-inline-end:"D:\sale\src\pages\sub-categories\sub-categories.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
...
var CategoriesPage = (function () {
    ...
    CategoriesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\categories\categories.html"*/'<ion-header>\n\n\n\n  <ion-navbar>\n\n    <button ion-button icon-only menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n\n\n    <ion-title>\n\n      {{\'Categories\'| translate }}\n\n    </ion-title>\n\n\n\n    <ion-buttons end>\n\n      <button ion-button icon-only (click)="openSearch()">\n\n        <ion-icon name="search"></ion-icon>\n\n      </button>\n\n      <button ion-button icon-only class="cart-button" (click)="openCart()">\n\n        <ion-icon name="cart">\n\n          <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n\n        </ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n<ion-content>\n\n\n\n  <ion-grid>\n\n    <ion-row>\n\n      <ion-col col-6 *ngFor="let c of shared.categories" (click)="openSubCategories(c.id)" class="animated flipInX">\n\n        <ion-card>\n\n        	\n\n            <div class="category-icon"><img *ngIf="c.image" src="{{c.image.src}}" /></div>\n\n            <div class="cateogry-content">\n\n                <div class="categories-title">{{c.name}}</div>\n\n                <div class="categories-subtitle">{{c.count}} {{\'Products\'| translate }} </div>\n\n            </div>\n\n        </ion-card>\n\n      </ion-col>\n\n    </ion-row>\n\n  </ion-grid>\n\n</ion-content>\n\n<ion-footer *ngIf="config.footerShowHide==\'1\'">\n\n  <footer></footer>\n\n</ion-footer>'/*ion-inline-end:"D:\sale\src\pages\categories\categories.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
            __WEBPACK_IMPORTED_MODULE_3__providers_config_config__["a" /* ConfigProvider */]])
...
var Categories4Page = (function () {
    ...
    Categories4Page = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\categories4\categories4.html"*/'<ion-header>\n    \n      <ion-navbar>\n        <button ion-button icon-only menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    \n        <ion-title>\n          {{\'Categories\'| translate }}\n        </ion-title>\n    \n        <ion-buttons end>\n          <button ion-button icon-only (click)="openSearch()">\n            <ion-icon name="search"></ion-icon>\n          </button>\n          <button ion-button icon-only class="cart-button" (click)="openCart()">\n            <ion-icon name="cart">\n              <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n            </ion-icon>\n          </button>\n        </ion-buttons>\n      </ion-navbar>\n    \n    </ion-header>\n  \n  <ion-content class="page-categories4">\n      <ion-grid>\n          <ion-row>\n            <ion-col col-6  *ngFor="let c of shared.categories" (click)="openSubCategories(c.id)" class="animated flipInX">\n                <ion-card>\n                  <img *ngIf="c.image" src="{{c.image.src}}"/>\n                  <div class="categories-title">{{c.name}}</div>\n                  <div class="categories-subtitle">{{c.count}} {{\'Products\'| translate }} </div>\n                </ion-card>\n            </ion-col>\n          </ion-row>\n        </ion-grid>\n\n    \n  </ion-content>\n  <ion-footer *ngIf="config.footerShowHide==\'1\'">\n    <footer ></footer>\n  </ion-footer>'/*ion-inline-end:"D:\sale\src\pages\categories4\categories4.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
            __WEBPACK_IMPORTED_MODULE_3__providers_config_config__["a" /* ConfigProvider */]])
...
var Categories3Page = (function () {
    ...
    Categories3Page = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\categories3\categories3.html"*/'<ion-header>\n    \n      <ion-navbar>\n        <button ion-button icon-only menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    \n        <ion-title>\n          {{\'Categories\'| translate }}\n        </ion-title>\n    \n        <ion-buttons end>\n          <button ion-button icon-only (click)="openSearch()">\n            <ion-icon name="search"></ion-icon>\n          </button>\n          <button ion-button icon-only class="cart-button" (click)="openCart()">\n            <ion-icon name="cart">\n              <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n            </ion-icon>\n          </button>\n        </ion-buttons>\n      </ion-navbar>\n    \n    </ion-header>\n  \n  \n  <ion-content class="page-categories3">\n      <ion-list>\n          <ion-item *ngFor="let c of shared.categories" (click)="openSubCategories(c.id)" class="animated flipInX">\n            <ion-avatar item-start>\n              <img *ngIf="c.image"  src="{{c.image.src}}">\n            </ion-avatar>\n            <h2>{{c.name}}<br><small>{{c.count}} {{\'Products\'| translate }} </small></h2>\n          </ion-item>\n        </ion-list>\n      \n  </ion-content>\n  <ion-footer *ngIf="config.footerShowHide==\'1\'">\n    <footer ></footer>\n  </ion-footer>'/*ion-inline-end:"D:\sale\src\pages\categories3\categories3.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
            __WEBPACK_IMPORTED_MODULE_3__providers_config_config__["a" /* ConfigProvider */]])
...
var Categories6Page = (function () {
    ...
    Categories6Page = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\categories6\categories6.html"*/'<ion-header>\n    \n      <ion-navbar>\n        <button ion-button icon-only menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    \n        <ion-title>\n          {{\'Categories\'| translate }}\n        </ion-title>\n    \n        <ion-buttons end>\n          <button ion-button icon-only (click)="openSearch()">\n            <ion-icon name="search"></ion-icon>\n          </button>\n          <button ion-button icon-only class="cart-button" (click)="openCart()">\n            <ion-icon name="cart">\n              <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n            </ion-icon>\n          </button>\n        </ion-buttons>\n      </ion-navbar>\n    \n    </ion-header>\n\n\n<ion-content class="page-categories6">\n\n  <ion-card *ngFor="let c of shared.categories" (click)="openSubCategories(c.id)" class="animated flipInX">\n    <img *ngIf="c.image" src="{{c.image.src}}" />\n    <div class="categories-title">{{c.name}}</div>\n    <div class="categories-subtitle">{{c.count}} {{\'Products\'| translate }} </div>\n  </ion-card>\n\n</ion-content>\n<ion-footer *ngIf="config.footerShowHide==\'1\'">\n  <footer ></footer>\n</ion-footer>'/*ion-inline-end:"D:\sale\src\pages\categories6\categories6.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
            __WEBPACK_IMPORTED_MODULE_3__providers_config_config__["a" /* ConfigProvider */]])
...
var AboutUsPage = (function () {
    ...
    AboutUsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about-us',template:/*ion-inline-start:"D:\sale\src\pages\about-us\about-us.html"*/'\n\n<ion-header>\n\n    <ion-navbar>\n\n      <button ion-button icon-only menuToggle>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n  \n\n      <ion-title>\n\n        {{\'About Us\'| translate }}\n\n      </ion-title>\n\n  \n\n      <ion-buttons end>\n\n        <button ion-button icon-only (click)="openSearch()">\n\n          <ion-icon name="search"></ion-icon>\n\n        </button>\n\n        <button ion-button icon-only class="cart-button" (click)="openCart()">\n\n          <ion-icon name="cart">\n\n            <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n\n          </ion-icon>\n\n        </button>\n\n      </ion-buttons>\n\n    </ion-navbar>\n\n  </ion-header>\n\n\n\n<ion-content class="page-about-us" padding>\n\n  <div class="page-content" [innerHTML]="shared.aboutUs"></div>\n\n  <ion-list>\n\n    <button ion-item (click)="openSite()">\n\n      {{"Official Website"|translate}}\n\n      <ion-icon showWhen="android" name="arrow-forward" item-end></ion-icon>\n\n    </button>\n\n    <button ion-item (click)="showModal(\'privacyPolicy\')">\n\n        {{\'Privacy Policy\'|translate}}\n\n        <ion-icon showWhen="android" name="arrow-forward" item-end></ion-icon>\n\n        \n\n    </button>\n\n    <button ion-item (click)="showModal(\'refundPolicy\')">\n\n        {{\'Refund Policy\'|translate}}\n\n        <ion-icon showWhen="android" name="arrow-forward" item-end></ion-icon>\n\n        \n\n    </button>\n\n    <button ion-item (click)="showModal(\'termServices\')">\n\n        {{\'Term and Services\'|translate}}\n\n        <ion-icon showWhen="android" name="arrow-forward" item-end></ion-icon>\n\n        \n\n    </button>\n\n  </ion-list>\n\n</ion-content>\n\n<!-- <ion-footer *ngIf="config.footerShowHide==1">\n\n  <footer ></footer>\n\n</ion-footer> -->'/*ion-inline-end:"D:\sale\src\pages\about-us\about-us.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* ModalController */],
...
var SubCategories2Page = (function () {
    ...
    SubCategories2Page = SubCategories2Page_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\sub-categories2\sub-categories2.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>\n      {{\'Sub Categories\'| translate }}\n    </ion-title>\n\n    <ion-buttons end>\n      <button ion-button icon-only (click)="openSearch()">\n        <ion-icon name="search"></ion-icon>\n      </button>\n      <button ion-button icon-only class="cart-button" (click)="openCart()">\n        <ion-icon name="cart">\n          <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n        </ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content text-center>\n  <ion-list>\n    <div *ngFor="let c of shared.subCategories" (click)="openProducts(c.id,c.name)" class="animated flipInX">\n      <ion-item *ngIf="c.parent==parent">\n        <ion-thumbnail item-start>\n          <img *ngIf="c.image" src="{{c.image.src}}">\n        </ion-thumbnail>\n        <h2>{{c.name}}\n          <br>\n          <small>{{c.count}} {{\'Products\'| translate }} </small>\n        </h2>\n      </ion-item>\n    </div>\n  </ion-list>\n  <button ion-button icon-end color="secondary" (click)="openParentProducts()">{{ \'View All\' | translate }}\n    <ion-icon name="ios-arrow-dropright-circle-outline"></ion-icon>\n  </button>\n</ion-content>'/*ion-inline-end:"D:\sale\src\pages\sub-categories2\sub-categories2.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
...
var SubCategories4Page = (function () {
    ...
    SubCategories4Page = SubCategories4Page_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\sub-categories4\sub-categories4.html"*/'<ion-header>\n    \n      <ion-navbar>\n        <ion-title>\n          {{\'Sub Categories\'| translate }}\n        </ion-title>\n    \n        <ion-buttons end>\n          <button ion-button icon-only (click)="openSearch()">\n            <ion-icon name="search"></ion-icon>\n          </button>\n          <button ion-button icon-only class="cart-button" (click)="openCart()">\n            <ion-icon name="cart">\n              <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n            </ion-icon>\n          </button>\n        </ion-buttons>\n      </ion-navbar>\n    \n    </ion-header>\n<ion-content text-center class="card-background-page">\n  <ion-grid>\n      <ion-row>\n        <ion-col col-6  *ngFor="let c of subcategories" (click)="openProducts(c.id,c.name)" class="animated flipInX">\n            <ion-card >\n              <img *ngIf="c.image" src="{{c.image.src}}"/>\n              <div class="categories-title">{{c.name}}</div>\n              <div class="categories-subtitle">{{c.count}} {{\'Products\'| translate }} </div>\n            </ion-card>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n    <button ion-button icon-end color="secondary" (click)="openParentProducts()">{{ \'View All\' | translate }}\n      <ion-icon name="ios-arrow-dropright-circle-outline"></ion-icon>\n  </button>\n</ion-content>'/*ion-inline-end:"D:\sale\src\pages\sub-categories4\sub-categories4.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
...
var SubCategories3Page = (function () {
    ...
    SubCategories3Page = SubCategories3Page_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\sub-categories3\sub-categories3.html"*/'<ion-header>\n    \n      <ion-navbar>\n        <ion-title>\n          {{\'Sub Categories\'| translate }}\n        </ion-title>\n    \n        <ion-buttons end>\n          <button ion-button icon-only (click)="openSearch()">\n            <ion-icon name="search"></ion-icon>\n          </button>\n          <button ion-button icon-only class="cart-button" (click)="openCart()">\n            <ion-icon name="cart">\n              <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n            </ion-icon>\n          </button>\n        </ion-buttons>\n      </ion-navbar>\n    \n    </ion-header>\n\n<ion-content text-center class="card-background-page">\n  \n  <ion-list>\n    <div *ngFor="let c of shared.subCategories" (click)="openProducts(c.id,c.name)" class="animated flipInX">\n      <ion-item *ngIf="c.parent==parent">\n        <ion-avatar item-start>\n          <img *ngIf="c.image" src="{{c.image.src}}">\n        </ion-avatar>\n        <h2>{{c.name}}<br><small>{{c.count}} {{\'Products\'| translate }} </small></h2>\n      </ion-item>\n    </div>\n    </ion-list>\n\n    <button ion-button icon-end color="secondary" (click)="openParentProducts()">{{ \'View All\' | translate }}\n      <ion-icon name="ios-arrow-dropright-circle-outline"></ion-icon>\n  </button>\n</ion-content>'/*ion-inline-end:"D:\sale\src\pages\sub-categories3\sub-categories3.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
...
var ConfigProvider = (function () {
    function ConfigProvider(http, storage, platform, localNotifications) {
        ...
        this.platform = platform;
        this.localNotifications = localNotifications;
        this.url = 'http://whatisonsale.net/beta';
        this.consumerKey = 'ck_d3a94012ade9a0e67c3be30979f0e791d7093291';
        this.consumerSecret = 'cs_f1973c679580cf08c65ebfb225b73c846a298bc5';
...
var BannersComponent = (function () {
    ...
    BannersComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'banners',template:/*ion-inline-start:"D:\sale\src\components\banners\banners.html"*/'<ion-slides pager="true" paginationType="bullets" dir="{{shared.dir}}">\n  <ion-slide *ngFor="let b of shared.banners" (click)="bannerClick(b)">\n    <img src="{{b.banners_image}}">\n  </ion-slide>\n</ion-slides>\n<!-- autoplay="5000" -->'/*ion-inline-end:"D:\sale\src\components\banners\banners.html"*/
        }),
...
var SubCategories5Page = (function () {
    ...
    SubCategories5Page = SubCategories5Page_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sub-categories5',template:/*ion-inline-start:"D:\sale\src\pages\sub-categories5\sub-categories5.html"*/'<ion-header>\n    \n      <ion-navbar>\n        <ion-title>\n          {{\'Sub Categories\'| translate }}\n        </ion-title>\n    \n        <ion-buttons end>\n          <button ion-button icon-only (click)="openSearch()">\n            <ion-icon name="search"></ion-icon>\n          </button>\n          <button ion-button icon-only class="cart-button" (click)="openCart()">\n            <ion-icon name="cart">\n              <ion-badge color="secondary">{{shared.cartquantity}}</ion-badge>\n            </ion-icon>\n          </button>\n        </ion-buttons>\n      </ion-navbar>\n    \n    </ion-header>\n\n<ion-content class="card-background-page">\n\n  <div *ngFor="let c of shared.subCategories">\n    <ion-card *ngIf="c.parent==parent" (click)="openProducts(c.id,c.name)" class="animated flipInX"> \n      <img *ngIf="c.image" src="{{c.image.src}}" />\n      <div class="card-title">{{c.name}}</div>\n      <div class="card-subtitle">{{c.count}} {{\'Products\'| translate }} </div>\n    </ion-card>\n  </div>\n  \n</ion-content>'/*ion-inline-end:"D:\sale\src\pages\sub-categories5\sub-categories5.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            ],template:/*ion-inline-start:"D:\sale\src\pages\home\home.html"*/'<ion-header>\n\n  <ion-navbar>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n\n    <ion-title text-center>\n      What is on sale\n    </ion-title>\n\n    <ion-buttons end>\n      <button ion-button icon-only (click)="openSearch()">\n        <ion-icon name="search"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content class="page-home" (ionScroll)="onScroll($event)">\n  <!-- top banners -->\n  <banners></banners>\n\n\n  <sliding-tabs></sliding-tabs>\n  <ion-fab bottom right *ngIf="scrollTopButton">\n    <button ion-fab (click)="scrollToTop()">\n      <ion-icon name="arrow-round-up"></ion-icon>\n    </button>\n  </ion-fab>\n\n</ion-content>\n<ion-footer *ngIf="config.footerShowHide==\'1\'">\n  <footer></footer>\n</ion-footer>'/*ion-inline-end:"D:\sale\src\pages\home\home.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */],
            __WEBPACK_IMPORTED_MODULE_3__providers_config_config__["a" /* ConfigProvider */],
            __WEBPACK_IMPORTED_MODULE_5__providers_shared_data_shared_data__["a" /* SharedDataProvider */],
